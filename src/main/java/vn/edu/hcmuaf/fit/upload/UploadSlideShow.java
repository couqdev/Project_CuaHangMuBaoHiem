...
@WebServlet(name = "UploadSlideShow", value = "/UploadSlideShow")
public class UploadSlideShow extends HttpServlet {
...
//                out.write("Thêm thành công");
                SlideShowService.getInstance().insertSlideShow("/Project_CuaHangMuBaoHiem_war/manage/upload/"+fileItem.getName());
