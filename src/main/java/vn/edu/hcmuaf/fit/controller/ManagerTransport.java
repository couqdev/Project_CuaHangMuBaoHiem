...
@WebServlet(name = "ManagerTransport", value = "/ManagerTransport")
public class ManagerTransport extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("ManageTransport.jsp").forward(request,response);
