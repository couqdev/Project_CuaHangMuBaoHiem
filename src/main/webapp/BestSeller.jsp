...
<head>
    ...
    <%if (listMonth.size() >= 3) {%>
    <script src="admin/assets/js/pie_best.js"
            onload="getData([<%=listMonth.get(0).getQuantity()%>,<%=listMonth.get(1).getQuantity()%>,<%=listMonth.get(2).getQuantity()%>])"
            defer></script>
    <%}%>
    <%if (listYear.size() >= 3) {%>
    <script src="admin/assets/js/pie_best2.js"
            onload="getData([<%=listYear.get(0).getQuantity()%>,<%=listYear.get(1).getQuantity()%>,<%=listYear.get(2).getQuantity()%>])"
            defer></script>
    <%}%>
</head>
<body>
              ...
              ></span>
                    ...
                    <template x-if="isPagesMenuOpen">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="<%="/Project_CuaHangMuBaoHiem_war/SalesRate?index=" + "1"%>">Tỉ
                                    lệ bán được</a>
                            </li>
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full"
                                   href="<%="/Project_CuaHangMuBaoHiem_war/ProductReturn?index=" + "1"%>">Tỉ lệ trả
                                    hàng</a>
                            </li>
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full"
                                   href="<%="/Project_CuaHangMuBaoHiem_war/CheckInventory?index=" + "1"%>">Sản phẩm tồn
                                    kho</a>
                            </li>
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full"
                                   href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + "1"%>">Sản
                                    phẩm cần nhập kho</a>
                            </li>
                            <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="<%="/Project_CuaHangMuBaoHiem_war/LatestSale?index=" + "1"%>">Sản
                                    phẩm không bán được</a>
                            </li>
                        </ul>
                    </template>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-semibold"><%=p1.getName() %>
                                            </p>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            <p class="font-semibold"><%=p2.getName() %>
                                            </p>
                                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                                <%=p2.getId() %>
                                            </p>
