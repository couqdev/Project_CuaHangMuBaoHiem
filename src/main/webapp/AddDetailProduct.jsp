        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                ...
                <div
                    ...
                    <form id="addDetailProduct" action="/Project_CuaHangMuBaoHiem_war/AddSCQ" method="get">
                        ...
                        <label style="margin-top: 20px;" class="block text-sm">
                            ...
                            <input id="color" name="color" required="required" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                   placeholder="Màu sắc"/>
                        </label>
                        ...
                        <button onclick="checkSCQ()" type="submit" style="margin-top: 20px; float: right; background: #1c7430;" class="px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                            Thêm
                        </button>
                    </form>
                </div>
