...
<head>
    ...
    <title>Thống kê sản phẩm không bán được từ thời gian nào đến thời gian nào</title>
    <link
        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
            ...
            >
                ...
                <div class="flex justify-center flex-1 lg:mr-32">
                    ...
                    >
                        <form action="/Project_CuaHangMuBaoHiem_war/find_product_latest_sale" method="get">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container grid px-6 mx-auto">
                <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                    Thống kê sản phẩm không bán được từ thời gian nào đến thời gian nào
                </h2>
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                ...
                                <th class="px-4 py-3">Lần bán ra mới nhất</th>
                                <th class="px-4 py-3">Hiện tại</th>
                            </tr>
                            </thead>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <%if(p.getLatestSale().equals("null")){%>
                    ...
                    <div
                        ...
                        <%
                            ...
                            if((String)request.getAttribute("text")==null){
                                ...
                                link += "/Project_CuaHangMuBaoHiem_war/LatestSale?index=";
                            }else{
                                size = ProductService.findProduct((String)request.getAttribute("text")).size();
                                link += "/Project_CuaHangMuBaoHiem_war/find_product_latest_sale?text="+(String)request.getAttribute("text")+"&index=";
                            }
