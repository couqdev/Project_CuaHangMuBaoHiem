          ...
          >
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              ...
              >
                ...
                <form action="/Project_CuaHangMuBaoHiem_war/find-customer" method="get">
                  <div class="absolute inset-y-0 flex items-center pl-2">
                    <svg
                            class="w-4 h-4"
                            aria-hidden="true"
              ...
              >
                <%
                  ...
                  if((String)request.getAttribute("text")==null){
                    size= ProductService.getData_Customer().size();
                  }else{
                    size = ProductService.findCustomer((String)request.getAttribute("text")).size();
                  }
                  ...
                  <nav aria-label="Table navigation">
                    <ul class="inline-flex items-center">
                      ...
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        ...
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + 1%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==1? "text-white bg-purple-600":""%>">
                          1
                        </button></a></li>
                      <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + 2%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==2? "text-white bg-purple-600":""%>">
                          2
                        </button></a></li>
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (endPage-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-1)? "text-white bg-purple-600":""%>">
                          <%=endPage-1%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + endPage%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==endPage? "text-white bg-purple-600":""%>">
                          <%=endPage%>
                        </button></a></li>
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        <a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + next%>"><button class="px-3 py-1 rounded-md rounded-r-lg focus:outline-none focus:shadow-outline-purple" aria-label="Next">
                      ...
                      <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + 2%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==2? "text-white bg-purple-600":""%>">
                        ...
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + 3%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==3? "text-white bg-purple-600":""%>">
                          3
                        </button></a></li>
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (endPage-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-1)? "text-white bg-purple-600":""%>">
                      ...
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        ...
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (endPage-2)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-2)? "text-white bg-purple-600":""%>">
                          <%=endPage-2%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (endPage-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-1)? "text-white bg-purple-600":""%>">
                          <%=endPage-1%>
                      ...
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        ...
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (index-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(index-1)? "text-white bg-purple-600":""%>">
                          <%=index-1%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (index)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(index)? "text-white bg-purple-600":""%>">
                          <%=index%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/list-customer?index=" + (index+1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(index+1)? "text-white bg-purple-600":""%>">
                          <%=index+1%>
