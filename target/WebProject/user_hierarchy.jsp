      ...
      >
        ...
        <div class="flex justify-center flex-1 lg:mr-32">
          ...
          >
            ...
            <form action="/Project_CuaHangMuBaoHiem_war/find-customer-permission" method="get">
              <div class="absolute inset-y-0 flex items-center pl-2">
                <svg
                        class="w-4 h-4"
                        aria-hidden="true"
          ...
          <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3 text-sm">
                  <%
                    String role = CustomerService.getRole(c.getPermission());
                    int id = c.getId_customer();
                    List<String> list_permission = CustomerService.getListRole(c.getPermission());
                  ...
                  <select
                          ...
                          onchange="changeAllow(this,<%=id%>)"
                  >
                    <option><%=role%></option>
                      <%for(String r:list_role){%>
                    <option><%=r%></option>
                      <%}%>
                </td>
              </tr>
          ...
          >
            <%
              ...
              if((String)request.getAttribute("text")==null){
                size= CustomerService.getListCustomerWithoutAdmin().size();
                link += "/Project_CuaHangMuBaoHiem_war/user_hierarchy?index=";
              }else{
                size = CustomerService.findCusWthoutAdmin((String)request.getAttribute("text")).size();
                link += "/Project_CuaHangMuBaoHiem_war/user_hierarchy?text= "+(String)request.getAttribute("text")+"index=";
              }
...
<script>
  function changeAllow(obj,id)
  {
    let value = obj.value;
    window.location = "/Project_CuaHangMuBaoHiem_war/change_role?name=" + value+"&id="+id;
