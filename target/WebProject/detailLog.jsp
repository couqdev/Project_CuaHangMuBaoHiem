        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container grid px-6 mx-auto">
                ...
                <%
                    ...
                    List<Log> list = (List<Log>) request.getAttribute("detail_log");
                  ...
                  <nav aria-label="Table navigation">
                    <ul class="inline-flex items-center">
                      <li class="page-item <%=index==1? "disabled":""%>">
                        <a href="/Project_CuaHangMuBaoHiem_war/detail-log?userName=<%=user%>&index=<%=pre%>"><button class="px-3 py-1 rounded-md rounded-l-lg focus:outline-none focus:shadow-outline-purple" aria-label="Previous">
                      ...
                      <%for(int i = 1; i <= endPage; i++){%>
                        <li>
                        <a  href="/Project_CuaHangMuBaoHiem_war/detail-log?userName=<%=user%>&index=<%=i%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==i? "text-white bg-purple-600":""%>">
                          <%=i%>
                        </button></a>
                        </li>
                      <%}%>
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        <a href="/Project_CuaHangMuBaoHiem_war/detail-log?userName=<%=user%>&index=<%=next%>"><button class="px-3 py-1 rounded-md rounded-r-lg focus:outline-none focus:shadow-outline-purple" aria-label="Next">
                          <svg class="w-4 h-4 fill-current" aria-hidden="true" viewBox="0 0 20 20">
