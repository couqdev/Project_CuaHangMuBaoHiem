        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
            ...
            >
                ...
                <div class="flex justify-center flex-1 lg:mr-32">
                    ...
                    >
                        <form action="/Project_CuaHangMuBaoHiem_war/find-product-inventory" method="get">
                    ...
                    <div
                        ...
                        <%
                            ...
                            if((String)request.getAttribute("text")==null){
                                ...
                                link += "/Project_CuaHangMuBaoHiem_war/CheckInventory?index=";
                            }else{
                                size = ProductService.findProduct((String)request.getAttribute("text")).size();
                                link+="/Project_CuaHangMuBaoHiem_war/find-product-inventory?text="+(String)request.getAttribute("text")+"&index=";
                            }
