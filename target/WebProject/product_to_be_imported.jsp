                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                ...
                                <th class="px-4 py-3">Tổng số lượng còn lại</th>
                            </tr>
                            </thead>
                  ...
                  <nav aria-label="Table navigation">
                    <ul class="inline-flex items-center">
                      <%if(endPage<=7){%>
                        ...
                        <a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + pre%>"><button class="px-3 py-1 rounded-md rounded-l-lg focus:outline-none focus:shadow-outline-purple" aria-label="Previous">
                      ...
                      <%for(int i = 1; i <= endPage; i++){%>
                        <li>
                        <a  href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + i%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==i? "text-white bg-purple-600":""%>">
                          <%=i%>
                        </button></a>
                        </li>
                      <%}%>
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        <a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + next%>"><button class="px-3 py-1 rounded-md rounded-r-lg focus:outline-none focus:shadow-outline-purple" aria-label="Next">
                          <svg class="w-4 h-4 fill-current" aria-hidden="true" viewBox="0 0 20 20">
                        ...
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + 1%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==1? "text-white bg-purple-600":""%>">
                          1
                        </button></a></li>
                      <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + 2%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==2? "text-white bg-purple-600":""%>">
                          2
                        </button></a></li>
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (endPage-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-1)? "text-white bg-purple-600":""%>">
                          <%=endPage-1%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + endPage%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==endPage? "text-white bg-purple-600":""%>">
                          <%=endPage%>
                        </button></a></li>
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        <a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + next%>"><button class="px-3 py-1 rounded-md rounded-r-lg focus:outline-none focus:shadow-outline-purple" aria-label="Next">
                      ...
                      <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + 2%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==2? "text-white bg-purple-600":""%>">
                        ...
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + 3%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==3? "text-white bg-purple-600":""%>">
                          3
                        </button></a></li>
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (endPage-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-1)? "text-white bg-purple-600":""%>">
                      ...
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        ...
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (endPage-2)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-2)? "text-white bg-purple-600":""%>">
                          <%=endPage-2%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (endPage-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(endPage-1)? "text-white bg-purple-600":""%>">
                          <%=endPage-1%>
                      ...
                      <li class="page-item <%=index==endPage? "disabled":""%>">
                        ...
                        <li>...</li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (index-1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(index-1)? "text-white bg-purple-600":""%>">
                          <%=index-1%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (index)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(index)? "text-white bg-purple-600":""%>">
                          <%=index%>
                        </button></a></li>
                        <li><a href="<%="/Project_CuaHangMuBaoHiem_war/ProductsToBeImported?index=" + (index+1)%>"><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple <%=index==(index+1)? "text-white bg-purple-600":""%>">
                          <%=index+1%>
